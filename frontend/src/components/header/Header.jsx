...
export const Header = () => {
  ...
  return (
      <nav className="bg-[#000000] border-b border-white/40 w-full h-16 top-0 z-20 font-medium fixed">
              ...
              <div className="items-center justify-between block">
                    <a href="/" className='flex text-white font-Cookie'>
                        <img
                            ...
                            height={50}
                            alt="Float UI logo"
                            className='w-11 h-11 lg:w-12 lg:h-12 mt-2 lg:mt-1'
                        />
                    ...
                    <div>
                        <ul className="flex lg:space-x-7 flex-row">
                            {!loading&&(isAuthenticated?(<>
                                <li className="">
                                        <a href="/me"><img className="mt-1 lg:mt-0 h-11 w-11 lg:h-12 lg:w-12 rounded-full"
                                            src={user.profilePhoto}
                                            alt="userImage1"
                                            /></a>
                                </li>
                                <li className="mt-3 ml-1">
                                    <a onClick={logoutButton} className="py-2 mx-2 lg:mx-0 text-sm lg:text-lg  px-2 lg:py-2 lg:px-4 text-center text-black bg-[#bdbcbc] hover:bg-[#a8a8a8] rounded-md shadow inline hover:cursor-pointer">
                                        Logout
                                    </a>
                                    </li>
                                </>
