...
export const Header = () => {
  ...
  return (
      <nav className="bg-[#000000] border-b border-white/40 w-full h-17 lg:h-16 top-0 z-20 font-medium fixed">
                    ...
                    <div>
                        <ul className="flex lg:space-x-7 flex-row">
                            {!loading&&(isAuthenticated?(<>
                                <li className="">
                                        <a href="/me"><img className="mt-1 lg:mt-0 h-12 w-12 rounded-full"
                                            src={user.profilePhoto}
                                            alt="userImage1"
                                            /></a>
                                </li>
                                <li className="mt-4 lg:mt-3 ml-1">
                                    <a onClick={logoutButton} className="py-3 ml-2 lg:ml-0 text-sm lg:text-lg  px-3  lg:px-4 text-center text-black bg-[#bdbcbc] hover:bg-[#a8a8a8] rounded-md shadow inline hover:cursor-pointer">
                                        Logout
                                    </a>
                                    </li>
                                </>
